...
import { User, Lock, Bell, Clock, Zap, Shield, Save, Loader2, CheckCircle, AlertCircle, Eye, EyeOff, Info } from 'lucide-react';
...
const SettingsView: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'profile' | 'blast' | 'security'>('profile');
  ...
  const handleSaveBlastSettings = async () => {
    ...
    try {
      ...
      localStorage.setItem('blastSettings', JSON.stringify(blastSettings));
